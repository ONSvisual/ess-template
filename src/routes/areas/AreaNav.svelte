...
const areasArray = getContext("areasArray");
...
<Container marginBottom>
    <div class="select-container">
        <Select options={areasArray} mode="search" placeholder="Find an area name" idKey="areacd" labelKey="areanm" on:change={doSelect} autoClear />
    </div>
    <Twisty title="Browse areas" {open}>
        <Grid colwidth="narrow">
            ...
            <div blank>
                ...
                {#each areasArray.filter((el) => el.parentcd === parent.code) as area}
